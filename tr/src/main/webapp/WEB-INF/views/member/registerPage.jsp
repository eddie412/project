...
<body>
	<section id="content">
		<form role="form" method="post" autocomplete="off">
			...
			<div class="input_area">
				<label for="userPhone">휴대폰 번호</label> <input type="tel"
					id="userPhone" name="userPhone" placeholder="숫자만 입력해주세요"
					required="required" />
			</div>

			<div class="input_area">
				<label for="userAddr">주소</label> <input type="text" id="userAddr"
					name="userAddr" required="required" />
				<button type="button" name="addChk" id="addChk">주소찾기</button>
			</div>

			<div class="input_area">
				<label for="userBday">생년월일</label> <input type="date" id="userBday"
					name="userBday" placeholder="미성년자는 회원가입 불가" />
				<button class="ageChk" type="button" id="ageChk"
					onclick="fn_ageChk();" value="N">나이체크</button>
			</div>
